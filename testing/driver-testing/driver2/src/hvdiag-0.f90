...
! ...DEBUG VARIABLES...
  character(len=10) :: debugfl
  integer :: openstat  
!--------------------------------------------------------------------
  debugfl = 'diag.debug'
10 format(1x, A, I6)
11 format(1x, I6,I6,I6,I6,I6 )
  open( unit=83, file=debugfl, status='new', iostat=openstat )
...
! Generate orbital string
      ...
      write( unit=83, fmt=10 ) "Looping over alpha string ", pdets(i)
      write( unit=83, fmt=11 ) astring1(1), astring1(2), astring1(3), astring1(4), astring1(5)
! 1-e contribution
      int1e1=0d0
      do j=1, aelec
