     ...
     .    ksym,k1s,k1f,l1,iscr
      ...
      data bits /18,18,18,18,18,3,10,10,10,2,0/
      data bits4x /18,18,18,18,3,3,16,16,16,16,18/
     ...
     .             'k1s   ','k1f   ','k1l1  '/
      ...
      write(6,*) 'New release has changed fil4x,fil3x header records'
