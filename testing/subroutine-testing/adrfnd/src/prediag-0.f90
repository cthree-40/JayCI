...
! ...input integer scalars...
    integer, intent(in) :: cidim, moints1len, moints2len, pdetslen, qdetslen, adets, &
                           aelec, belec, bdets, orbitals, intdiagsguess, initguessdim
...
! ...real*8 scalars...
    real*8 :: ddot
! ...real*8 arrays...
    real*8, dimension( cidim, intdiagsguess )             :: intguess, hvectors
    real*8, dimension( intdiagsguess, intdiagsguess )      :: subham
! ...DSYEVR VARIABLES...
...
! ...input integer scalars...
    integer, intent(in) :: cidim, moints1len, moints2len, pdetslen, qdetslen, &
                           subblockdim, initgdim, orbitals, aelec, belec
! ...input integer arrays...
