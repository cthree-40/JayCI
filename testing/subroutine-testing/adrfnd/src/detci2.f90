...
!
!---------------------------------------------------------------
! genorbstring( index, electrons, orbitals, determs, string )
!---------------------------------------------------------------
  subroutine genorbstring( indx, electrons, orbitals, determs, &
    string )
    implicit none
    integer, intent(in) :: indx, electrons, orbitals, determs
    integer, dimension(electrons), intent(out) :: string
    integer :: i, j
    integer, dimension(electrons) :: string1, string2
!----------------------------
    do i=1, electrons
      string1(i) = i
    end do
    do i=1, indx-1
      string2=string1
      string1=0
      call nstrfnd( string2, electrons, orbitals, determs, string1 )
    end do
    string=string1
    return
  end subroutine
