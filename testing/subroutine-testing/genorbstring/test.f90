...
#ifdef HVDIAG
  integer, dimension(:), allocatable :: tadets, pstring, pstep, tbdets,&
                                        qstring, qstep, tdets, qcrossref, pcrossref
...
! Call subroutine
   ...
   call diagonal( pstring, pstep, tadetslen, qstring, qstep, tbdetslen, tadets, &
                  ...
                  adets, bdets, moints1, moints1len, moints2, moints2len, pcrossref, qcrossref,cidim, diagonals )
   print *, diagonals(1)
   print *, diagonals(2)
   print *, diagonals(3)
   print *, diagonals(4)
