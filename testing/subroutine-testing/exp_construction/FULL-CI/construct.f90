...
! Find orbitals differing in beta strings
  ...
  if ( pd .eq. 2 ) then
    dblexcitations = moints2( index2e2(pstring1(pdiffs(1,1)),pstring2(pdiffs(2,1)),&
                              pstring1(pdiffs(1,2)),pstring2(pdiffs(2,2)))) - &
                     moints2( index2e2(pstring1(pdiffs(1,1)),pstring2(pdiffs(2,1)),&
                              pstring1(pdiffs(2,2)),pstring2(pdiffs(1,2))))
  else if ( qd .eq. 2 ) then
    dblexcitations = moints2( index2e2(qstring1(qdiffs(1,1)),qstring2(qdiffs(2,1)),&
                              qstring1(qdiffs(1,2)),qstring2(qdiffs(2,2)))) - &
                     moints2( index2e2(qstring1(qdiffs(1,1)),qstring2(qdiffs(2,1)),&
                              qstring1(qdiffs(2,2)),qstring2(qdiffs(1,2))))
  else
