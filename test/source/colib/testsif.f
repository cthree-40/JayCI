 ...
 51    format('2e: basereclen=',i5,' nbft=',i4,' ifmt=',i2,
     .           ' lrec=',i6,' nmax=',i6,' ierr=',i2,' usage=',i6)
       ...
       write(6,*) ' Testing plab10/ulab10 compression multiple 32 '

       do i=1,32*32
         label(i)=mod(i,512)
       enddo
       call plab10(buffer,label,32*32)
      
c      call printbin(buffer,4) 

       call ulab10(buffer,labelout,32*32)
...
c     enddo
 ...
 56    format('COMPARE i=',i8,' in=',i8, ' out=',i8)
       ...
       write(6,*) ' Testing plab10/ulab10 compression arb. length '

       do i=1,32*31+10
         label(i)=mod(i,512)
       enddo
       call plab10(buffer,label,32*31+10)

c      call printbin(buffer,4) 

       call ulab10(buffer,labelout,32*31+10)
