...
subroutine acthv(In_Vector,MOints1,MOints2,M1Len,M2Len,pString,    &
  ...
  call GenOrbString(21, bElec, Orbitals, bDets, betastr  )
  write(*,"(1x,7i3)") alphastr
  write(*,"(1x,7i3)") betastr
  call GenOrbString(212, belec, Orbitals, bDets, betastr )
  write(*,"(1x,7i3)") betastr
  call GenOrbString(234, belec, Orbitals, bDets, betastr )
  write(*,"(1x,7i3)") betastr
  call GenOrbString(401, belec, Orbitals, bDets, betastr )
  write(*,"(1x,7i3)") betastr
  stop
#endif
  ! Zero out Out_vector
