...
c
      ...
      real*8 fwtime
c etime is intrinsic function
c      external etime, fwtime
c
      integer   numvl
c     parameter(numvl=3)
      parameter(numvl=2)
...
*10    continue
*c
*@elif defined unix  && ( ! defined  unicos)
c
c     # "generic" unix version.
c     # this isn't pretty, but it works almost everywhere.
c     #
...
c     # write out mtype and the map vectors ms(*) and mnl(*):
      if (idebug.eq.1) then
c
       write(nlist,*)'mtype:',(mtype(isym),isym=1,nbft)
c
